...
def train_test_model(train_df,test_df,encoder,name,WORD_EMBEDDING_SIZE):
    ...
    #test
    names = [ 'A','F','FT','L','LF','MN','O','PE','SC','SE','US']
...
names = [ 'A','F','FT','L','LF','MN','O','PE','SC','SE','US']
#glove results
utils.printClassificationReport(y_glove_all_pred, y_glove_all_true, classes=names,filename="ALL_CR_GLOVE_BASE_knn.txt")
utils.plotConfusionMatrix(y_glove_all_pred,y_glove_all_true,classes=names,saveFig=True, showGraph=False,filename="ALL_CM_GLOVE_BASE_knn.png")
#bert results
utils.printClassificationReport(y_bert_all_pred, y_bert_all_true, classes=names,filename="ALL_CR_BERT_U_BASE_knn.txt")
utils.plotConfusionMatrix(y_bert_all_pred,y_bert_all_true,classes=names,saveFig=True, showGraph=False,filename="ALL_CM_BERT_U_BASE_knn.png")
#distilbert results
utils.printClassificationReport(y_distilbert_all_pred, y_distilbert_all_true, classes=names,filename="ALL_CR_DISTILBERT_BASE_knn.txt")
utils.plotConfusionMatrix(y_distilbert_all_pred,y_distilbert_all_true,classes=names,saveFig=True, showGraph=False,filename="ALL_CM_DISTILBERT_BASE_knn.png")
#sbert results
utils.printClassificationReport(y_sbert_all_pred, y_sbert_all_true, classes=names,filename="ALL_CR_SBERT_BASE_knn.txt")
utils.plotConfusionMatrix(y_sbert_all_pred,y_sbert_all_true,classes=names,saveFig=True, showGraph=False,filename="ALL_CM_SBERT_BASE_knn.png")
#glove results
utils.printClassificationReport(y_use_all_pred, y_use_all_true, classes=names,filename="ALL_CR_USE_BASE_knn.txt")
utils.plotConfusionMatrix(y_use_all_pred,y_use_all_true,classes=names,saveFig=True, showGraph=False,filename="ALL_CM_USE_BASE_knn.png")